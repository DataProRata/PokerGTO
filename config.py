...
for directory in [MODELS_DIR, DATA_DIR, LOG_DIR, TRAINING_HISTORY_DIR, DOCS_DIR]:
...
GAME_PARAMS = {
    ...
    "use_antes": False,                # Whether to use antes in the game
    "ante_amount": 0.0,                # Ante amount (if used)
    "burn_cards": True,                # Whether to burn cards before dealing
}
...
INTERFACE = {
    ...
    "show_help_on_start": True,        # Show terminology help on startup
    "show_outs_calculation": True,     # Show outs calculation during play
    "show_pot_odds": True,             # Show pot odds during play
    "show_position_info": True,        # Show position information during play
}